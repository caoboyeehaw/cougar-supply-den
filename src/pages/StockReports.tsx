...
import MetricChartStock from '@/components/MetricChartStock';


const StocklReports: React.FC = () => {
      ...
      <div className="w-full max-w-4xl">
        <div className="bg-white shadow-xl rounded-2xl p-8 mx-auto">
          ...
          <div className="block font-semibold text-2xl text-gray-700" style={{ textAlign: "center" }}>
              ...
              {filteredProducts && <MetricChartStock products={filteredProducts} />}
            </div>
          </div>
