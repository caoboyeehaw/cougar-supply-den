...
async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
      ...
      if (productData.cart_id) {
        await pool.request()
          ...
          .query(`
            INSERT INTO [dbo].[purchasedProducts] (cart_id, cust_id, Product_id, quantity)
        ...
        await pool.request()
          ...
          .input('quantity', productData.quantity)
          .query(`
            INSERT INTO [dbo].[purchasedProducts] (cust_id, Product_id, quantity)
  ...
  await pool.request()
    .input('cart_id', cart_id)
    .query(`
      DELETE FROM [dbo].[purchasedProducts]
      WHERE cart_id = @cart_id
    `);
